...
function getSeriesDefinition(
  ...
  const definitions: Record<string, Omit<CardSeriesPlanItem, "index" | "type">> = {
    ...
    safety: {
      ...
      subheadline: "Нейтральные факты и аккуратная подача",
      bullets: ["Проверяйте описание", "Без неподтвержденных заявлений", "Честная карточка"],
    ...
    assortment: {
      ...
      subheadline: "Финальная карточка галереи",
    ...
    final_cta: {
      ...
      bullets: ["Сохраните карточку", "Сравните параметры", "Выберите подходящий вариант"],
      badges: ["Финал", "Выбор"],
