      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-2 text-sm font-semibold leading-relaxed text-muted">
            {cardTitle
              ? `«${cardTitle}» сохранена после регистрации. Откройте её в истории и скачайте без водяного знака — это ваша первая бесплатная карточка.`
              : "После регистрации демо-карточка сохраняется в истории. Откройте её и скачайте без водяного знака — это ваша первая бесплатная карточка."}
          </p>
        </div>
        <button
