...
export function HeroStudioVisual({ className = "" }: { className?: string }) {
  return (
    <div className={`relative mx-auto w-full max-w-[420px] lg:mx-0 lg:max-w-none ${className}`.trim()}>
      <div
        aria-hidden
      ...
      <div className="relative min-h-[300px] sm:min-h-[340px] lg:min-h-[380px]">
        ...
        <div className="absolute right-0 top-0 z-20 w-[58%] animate-float">
          ...
          <p className="mt-3 text-right text-xs font-bold uppercase tracking-[0.16em] text-accent">Готовая карточка</p>
        </div>
        ...
        <div className="absolute bottom-0 left-0 z-30 w-[50%]">
          ...
          <p className="mt-3 text-xs font-bold uppercase tracking-[0.16em] text-violet">Исходное фото</p>
        </div>
