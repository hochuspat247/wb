...
const variants = {
  primary:
    "bg-accent text-white border border-accent hover:bg-[#e84e32] hover:-translate-y-px active:translate-y-0",
  secondary:
    "border border-clay bg-card text-ink hover:border-ink/20 hover:bg-paper active:translate-y-0",
