...
const USER_FACING_MESSAGES: Record<ContentPolicyCategory, string> = {
  ...
  adult_content:
    "Генерация изображений для интимных и взрослых товаров запрещена политикой ИИ-провайдера. Загрузите другое фото или измените описание.",
  drugs:
    "Генерация изображений для запрещённых веществ запрещена политикой ИИ-провайдера.",
  violence:
    "Генерация изображений с насилием или жестокостью запрещена политикой ИИ-провайдера.",
  hate:
