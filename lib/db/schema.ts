...
export const users = sqliteTable("user", {
  ...
  storyGenerationCredits: integer("storyGenerationCredits").notNull().default(0),
  storyGenerationsUsed: integer("storyGenerationsUsed").notNull().default(0),
  storyMonthlyFreeUsed: integer("storyMonthlyFreeUsed").notNull().default(0),
  storyMonthlyFreePeriodStart: integer("storyMonthlyFreePeriodStart", { mode: "timestamp_ms" }),
  storyMonthlyFreePortraitUsed: integer("storyMonthlyFreePortraitUsed").notNull().default(0),
