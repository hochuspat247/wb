...
export function getMarketingFaqItems(): MarketingFaqItem[] {
  ...
  return [
    ...
    },
    {
      ...
      answer:
        "На бесплатном тарифе пробная карточка и демо сохраняются с защитной меткой. Скачать без водяного знака и собрать серию слайдов для одного товара можно после покупки комплекта."
    },
    {
      id: "pricing",
    ...
    },
    {
      ...
      answer:
        "Демо автоматически сохраняется в истории с водяным знаком. После регистрации доступна ещё 1 пробная карточка с меткой, один раз. Убрать знак и собрать серию — в платном комплекте."
    },
    {
      id: "ai-image",
